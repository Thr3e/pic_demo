        ...
        tabBasicData: {
            normal: [{
                ...
                items: [{
                    src: require('../assets/imgs/meta_icon/waimai.png'),
                    param: {
                        data: 'linear-gradient(#e66465, #9198e5)',
                        type: 'back'
                    }
                }, {
                    src: require('../assets/imgs/meta_icon/shutiao.png'),
                    param: {
                        data: 'linear-gradient(to right, red , yellow)',
                        type: 'back'
                    }
                }, {
                    src: require('../assets/imgs/meta_icon/yaopin.png'),
                    param: {
                        data: 'linear-gradient(to bottom right, red, yellow)',
                        type: 'back'
                    }
                }]
            }, {
                ...
                items: [{
                    src: require('../assets/imgs/meta_icon/zhushi.png'),
                    param: {
                        data: 'linear-gradient(-90deg, red, yellow)',
                        type: 'back'
                    }
                }, {
                    src: require('../assets/imgs/meta_icon/zhengcai.png'),
                    param: {
                        data: 'linear-gradient(red, yellow, green)',
                        type: 'back'
                    }
                }, {
                    src: require('../assets/imgs/meta_icon/zaocan.png'),
                    param: {
                        data: 'linear-gradient(to right, red,orange,yellow,green,blue,indigo,violet)',
                        type: 'back'
                    }
                }]
            }],
